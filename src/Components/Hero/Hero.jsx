...
"
          >
            Meet your{" "}
            <span className="grace-title text-inherit">Favourite</span> new
          ...
          <div className="flex flex-wrap gap-8 items-center mt-8">
            <button className="text-white px-16 shadow-[6px_6px_0px_#2E2F35] border-2 border-[#2E2F35] rounded-[15px] py-[1.5rem] bg-[#FF6D2C] hover:bg-white hover:text-black transition-all duration-300">
              Try it Risk-free
            </button>
